...
pub fn deref_example<'a>(swagger: &'a OpenApi310, reference: &str) -> Option<&'a Example> {
...
pub fn deref_request_body<'a>(swagger: &'a OpenApi310, reference: &str) -> Option<&'a RequestBody> {
    swagger.components.as_ref().and_then(|components| {
...
pub fn deref_header<'a>(swagger: &'a OpenApi310, reference: &str) -> Option<&'a Header> {
    swagger.components.as_ref().and_then(|components| {
...
pub fn deref_link<'a>(swagger: &'a OpenApi310, reference: &str) -> Option<&'a Link> {
    swagger.components.as_ref().and_then(|components| {
...
pub fn deref_response<'a>(swagger: &'a OpenApi310, reference: &str) -> Option<&'a Response> {
    swagger.components.as_ref().and_then(|components| {
